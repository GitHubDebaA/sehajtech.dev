...
export default function FollowUsButton() {
    return (
        <div className="flex items-center gap-6 text-white leading-none">
            ...
            <ul className="flex items-center gap-5">
                ...
                <li>
                    <a
                        href="#"
                        className="flex items-center justify-center w-6 h-6 transition-all duration-300 hover:scale-110 hover:text-[var(--primary-gold)]"
                    >
